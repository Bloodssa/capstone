...
>   
    <div class="flex items-center gap-4">
        <button @click.stop="sidebarOpen = !sidebarOpen"
            ...
            <svg width="28" height="28" class="text-neutral-900" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="space-x-3">
            <div class="flex space-x-3 items-center">
                ...
                <div class="flex items-center text-black space-x-2" @click.prevent="dropdownOpen = ! dropdownOpen">
                    ...
                    <span class="mr-1 block cursor-pointer font-semibold"> {{ Auth::user()->role === 'admin' ? 'Admin' : 'Staff' }}
                    </span>
            ...
            <ul class="flex flex-col mt-1">
                <li>
                    <a href="{{ route('manager.profile') }}"
                        ...
                        <svg class="fill-black" width="24" height="24" viewBox="0 0 24 24" fill="none"
