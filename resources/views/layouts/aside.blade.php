            ...
            <ul class="flex flex-col gap-1.5 -mt-2">
                <li>
                    <x-ui.manager.link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        <x-icons.svg :active="request()->routeIs('dashboard')"
            ...
            <ul class="flex flex-col gap-1 -mt-2">
                <li>
                    <x-ui.manager.link href="{{ route('add-product') }}" :active="request()->routeIs('add-product')">
                        <x-icons.svg :active="request()->routeIs('add-product')" viewBox="0 -960 960 960"
                ...
                <li>
                    <x-ui.manager.link href="{{ route('customers') }}" :active="request()->routeIs('customers')">
                        <x-icons.svg :active="request()->routeIs('customers')" viewBox="0 -960 960 960"
                            path="M555-435q-35-35-35-85t35-85q35-35 85-35t85 35q35 35 35 85t-35 85q-35 35-85 35t-85-35ZM400-160v-76q0-21 10-40t28-30q45-27 95.5-40.5T640-360q56 0 106.5 13.5T842-306q18 11 28 30t10 40v76H400Zm86-80h308q-35-20-74-30t-80-10q-41 0-80 10t-74 30Zm182.5-251.5Q680-503 680-520t-11.5-28.5Q657-560 640-560t-28.5 11.5Q600-537 600-520t11.5 28.5Q623-480 640-480t28.5-11.5ZM640-520Zm0 280ZM120-400v-80h320v80H120Zm0-320v-80h480v80H120Zm324 160H120v-80h360q-14 17-22.5 37T444-560Z" />
                        Customers
                    </x-ui.manager.link>
                </li>
                <li>
                    <x-ui.manager.link href="{{ route('reports') }}" :active="request()->routeIs('reports')">
                        <x-icons.svg :active="request()->routeIs('reports')" viewBox="0 -960 960 960"
            ...
            <ul class="flex flex-col gap-1 -mt-2">
                <li>
                    <x-ui.manager.link href="{{ route('staff-accounts') }}" :active="request()->routeIs('staff-accounts')">
                        <x-icons.svg :active="request()->routeIs('staff-accounts')" viewBox="0 -960 960 960"
                ...
                <li>
                    <x-ui.manager.link href="{{ route('manager.profile') }}" :active="request()->routeIs('manager.profile')">
                        <x-icons.svg :active="request()->routeIs('manager.profile')"
